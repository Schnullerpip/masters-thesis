...
\contentsline {lstlisting}{\numberline {7}The NPC class split into hot/cold data}{17}{lstlisting.7}% 
...
\contentsline {lstlisting}{\numberline {11}Excerpt of example context free grammar defining a (if)statement. Bold = terminal; italic = non terminal}{25}{lstlisting.11}% 
...
\contentsline {lstlisting}{\numberline {17}Examples of how we can change allocations using placement new to emplace the data where it is among related data.}{52}{lstlisting.17}% 
\contentsline {lstlisting}{\numberline {18}Code injection to generate contiguous block of memory for a record Foo's instances.}{54}{lstlisting.18}% 
\contentsline {lstlisting}{\numberline {19}Shortened excerpt of COOP's free list without asserts and some initialization code.}{56}{lstlisting.19}% 
...
\contentsline {lstlisting}{\numberline {22}Shortened excerpts for some AST Matchers to retrieve some of the information we need to implement changes \textendash second data aggregation.}{63}{lstlisting.22}% 
\contentsline {lstlisting}{\numberline {23}Assembling the proper access to a cold field through the additional indirection.}{64}{lstlisting.23}% 
\contentsline {lstlisting}{\numberline {24}Retrieving type information from a clang::MemExpr pointer.}{65}{lstlisting.24}% 
\contentsline {lstlisting}{\numberline {25}Traversing the constructors' delegating constructors until we find a 'root' node.}{65}{lstlisting.25}% 
\contentsline {lstlisting}{\numberline {26}Retrieving the size of a static array type through its AST node.}{68}{lstlisting.26}% 
\contentsline {lstlisting}{\numberline {27}Shortened version of COOP's container for the pointer to the cold data struct intance. It only defines a single field (the pointer) so no additional memory space is spend.}{69}{lstlisting.27}% 
\contentsline {lstlisting}{\numberline {28}Simplified source transformations for problematic cold field initializations in initialization list.}{70}{lstlisting.28}% 
