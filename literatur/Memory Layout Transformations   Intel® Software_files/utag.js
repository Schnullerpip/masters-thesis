//tealium universal tag - utag.loader ut4.46.201901152046, Copyright 2019 Tealium.com Inc. All Rights Reserved. 
...
/* Start Code */
  ...
  //set mbox path URL
  wap_tms.cb = (typeof(utag) !== 'undefined' && utag && utag.cfg && utag.cfg.v !== undefined) ? '?cb=' + utag.cfg.v : ''; //do we need cache buster? removed 4/22/16, may add back later
...
wap_tms.target.checkForNewBcVideos = function ($$) {
  if ($$ && typeof($$) === 'function') {
    var ids = $$('.video-id').map(function () {
      return parseInt(this.value.split('_')[1])
    }).get();
    var id = ids.length > 0 ? Math.max.apply(null, ids) : 100;
    $$('.new-bc-vid').each(function () {
      id++;
      var newVideo = $$(this);
      newVideo.attr('data-bc-placeholder', id);
      var player = newVideo.attr('player');
      var video = newVideo.attr('video');
      intel.bcLazyLoader.addPlayer({
        elementID: 'brightcovePlayer_' + id,
        playerID: player,
        playerKey: 'default',
        videoID: video,
        muted: false,
      ...
      newVideo.removeAttr('player');
      newVideo.removeAttr('video');
      newVideo.removeAttr('class');
    });
  }
}
...
function targetPageParamsAll() {
 ...
 var targetLogic = {
        ...
        'wa_topic': {
			'entity': function() {
				if (typeof(utag_data['wa_section']) !== 'undefined' && (utag_data['wa_section'].indexOf('intc') > -1 || utag_data['wa_section'].indexOf('iq') > -1)) {
					if (typeof(utag_data['wa_subject']) === 'string') {
						atJson.entity['wa_topic'] = utag_data['wa_subject'];
						var val = utag_data['wa_subject'];
						if (atJson.entity['wa_topic'].indexOf(",") != -1) {
							var vals = utag_data['wa_subject'].split(',');
  ...
  if(typeof utag_data.wa_login != 'undefined'){
	  atJson.wa_login = utag_data.wa_login;
  }
...
//*********************************************************************************************
//* Target at.js version 1.6.2                                                                *
//*********************************************************************************************
wap_tms.at_version = "1.6.2";

wap_tms.utility = wap_tms.utility || {};
wap_tms.utility.load_at_js = function () {
...
wap_tms.enableTarget = function () {
	...
	if (typeof wap_tms.utility.load_at_js == "function")
		wap_tms.utility.load_at_js();
	window.wap_atjs = {};
	var ga_params = {};
		...
		adobe.target.getOffer({
			...
			"success": function (offers) {
				if (wap_tms.custom.isSearchPage) {
                    ...
                    if (wap_tms.jquery.ver_1_7_plus) {
                        setTimeout(function() { wap_tms.target.checkForNewBcVideos($wap) }, 500);
                    }
...
//********** END DCP **************
  ...
  function setTargetAtProperty () {
    var value = 'n/a';
    var url = location.href;
    var pathname = location.pathname;
    var querstring = location.search;
    if (pathname.toString().indexOf('/target-test/') > -1
      || querstring.toString().toLowerCase().indexOf('targetTest'.toLowerCase()) > -1
      || pathname.toString().indexOf('/test/') > -1
      || url.toString().indexOf('wap01.amr.corp.intel.com') > -1
      || url.toString().indexOf('spearce-mobl1.amr.corp.intel.com') > -1) {
      value = '1c22feb6-172d-2bda-75dc-01fef242b07e';
    } else if (pathname.toString().indexOf('/programmable') > -1
      || (utag_data['wa_programidentifier'] && utag_data['wa_programidentifier'] == 'psg')
      || (utag_data['wa_section'] && utag_data['wa_section'].toString().indexOf('altera') > -1)) {
      value = '7dc418cf-2a59-3ba5-0df4-10380cb8a532';
    } else if (url.toString().indexOf('utcqcontent.cps.intel.com') > -1) {
      value = 'ab7de09f-34ea-58e1-fe05-32f69d435f59';
    } else if (utag_data['wa_section'] && utag_data['wa_section'].toString().indexOf('ssg') > -1) {
      value = '7754c48e-1e95-645a-0148-70cc9c0e82f';
    }
    utag_data.target_at_property = value;
  }
  ...
  if (utag_data.wa_load_tms_sync === 'sync') {
    wap_tms.enableTarget();
  }
...
if (!utag_condload) { //temp code until Tealium bug fixed - 5/12/14 
    ...
    wap_tms.pageLoadSyndication = function (page) {
      trackGaEvent('Navigation', 'nav: page', page);
    }
    ...
    var snm = tmsGetParamByName('snm');
    if (snm) { utag_data.wa_snm = snm.toLowerCase(); }
	...
	function wapCreateCookie(cookieName, cookieValue, cookieDuration){
		...
		document.cookie = cookieName+"="+cookieValue+expires+";secure; path=/;domain=" + tms_domain;
	}
...
fromGAToAA('metric', '101,hit', 'metric101', ['event59', 'eVar150']);
...
var idio_tag_executed = false;
wap_tms.custom.callIdioTag = function(timeHasPassed){
    //var timeHasPassed = false;
    if(timeHasPassed && !idio_tag_executed){
        if (typeof utag_data.tag_id_idio !== 'undefined') {
            utag.view({}, null, [utag_data.tag_id_idio]);
            idio_tag_executed = true;
        }
    }else{
		if (!idio_tag_executed) {
			timeHasPassed = true;
			setTimeout(function() {
				wap_tms.custom.callIdioTag(true);
			}, 500);   
		}
    }
}
...
if (wap_tms.jquery.ver_1_7_plus) {
	(function($) {
		setTimeout(function() {
			$("div.gs-bar a").on('click', function() {
				var id = $(this).attr('data-provider');
				trackGaEvent('Social', 'share: ' + id, utag_data.wa_pageName);
			});
		}, 7500);
	}($wap));
}  
...
if (typeof utag == "undefined" && !utag_condload) {
  ...
  utag.cfg = {
    ...
    utid: "intel/profile-ssg.intel/201901152046"
  };
  utag.cfg.v = utag.cfg.template + "201901152046";
  utag.cond={106:0,107:0,108:0,109:0,110:0,111:0,112:0,113:0,114:0,115:0,116:0,117:0,118:0,119:0,120:0,121:0,122:0,123:0,124:0,125:0,126:0,127:0,128:0,129:0,130:0,131:0,132:0,133:0,135:0,136:0,137:0,139:0,140:0,37:0,54:0,59:0,62:0,63:0,65:0,74:0,77:0,79:0,81:0,82:0,83:0,84:0,85:0,86:0,87:0,89:0,90:0,91:0,92:0,96:0,97:0};
...
case '139':try{c[139]|=  (utag.loader.chkCanRunTime("20181105----","20181231----")) && ((d['dom.url'].toString().toLowerCase().indexOf('/en-us/persistent-memory'.toLowerCase())>-1))}catch(e){utag.DB(e)}; break;
case '140':try{c[140]|=(d['load_getsocial'].toString().toLowerCase()=='true'.toLowerCase())}catch(e){utag.DB(e)}; break;
...
case '97':try{c[97]|=(d['dom.url'].toString().toLowerCase().indexOf('/en-us/smart-video'.toLowerCase())>-1)||(d['dom.url'].toString().toLowerCase().indexOf('/en-us/retail/displays'.toLowerCase())>-1)||(d['dom.url'].toString().toLowerCase().indexOf('/en-us/industrial'.toLowerCase())>-1)||(d['dom.url'].toString().toLowerCase().indexOf('/en-us/iot/reference-implementations'.toLowerCase())>-1)}catch(e){utag.DB(e)}; break;}}};utag.pre=function() {    utag.loader.initdata();utag.pagevars();    try{utag.loader.RD(utag.data)}catch(e){utag.DB(e)};    utag.loader.loadrules();    };utag.loader.GET=function(){utag.cl={'_all_':1};utag.pre();
...
function(a,b){ try{ if(/modern-code/.test(b['dom.pathname'])||b['wa_english_title'].toString().toLowerCase().indexOf('moderncode'.toLowerCase())>-1||b['wa_zone'].toString().toLowerCase().indexOf('modern code'.toLowerCase())>-1||b['wa_topic'].toString().toLowerCase().indexOf('modern code'.toLowerCase())>-1){try{b['wa_data_view_name']=(function() { var placeHolder= utag_data.wa_data_view_name;      if (placeHolder != 'empty'){             placeHolder = placeHolder +":"+ "modern code";      }else{          placeHolder = "modern code";      }      return placeHolder; })();}catch(e){}} } catch(e){ utag.DB(e) }  },
...
function(a,b){ try{ if(b['dom.pathname'].toString().indexOf('/en-us/home')>-1||b['dom.pathname'].toString().indexOf('/en-us/ai')>-1){b['target_load']='true';b['target_kpi']='none';b['target_params_page']='';b['target_params_profile']='';b['target_params_entity']=''} } catch(e){ utag.DB(e) }  },
...
wap_tms.custom.newSession = function () {
	...
	document.cookie = 'wap_new_session=1;secure;path=/;domain=' + tms_domain + expires;
	return res;
}
...
function(a,b){ try{ if((b['wa_product_name'].toString().indexOf('intelwirelessdisplay')>-1&&b['wa_section']=='intc')||(b['wa_topic'].toString().indexOf('collaboration')>-1&&b['wa_section']=='intc')||(b['wa_product_name'].toString().indexOf('intelunitesolution')>-1&&b['wa_section']=='intc')){b['wa_it_technology']='unite'} } catch(e){ utag.DB(e) }  }];
  utag.handler.cfg_extend=[{"bwq":0,"blr":0,"alr":1,"id":"30","end":0},{"end":0,"id":"31","blr":0,"alr":1,"bwq":0},{"end":0,"id":"39","blr":0,"alr":1,"bwq":0},{"id":"40","end":0,"bwq":0,"alr":1,"blr":0},{"id":"41","end":0,"bwq":0,"alr":1,"blr":0},{"id":"42","end":0,"bwq":0,"alr":1,"blr":0},{"alr":1,"blr":0,"bwq":0,"end":0,"id":"43"},{"end":0,"id":"44","blr":0,"alr":1,"bwq":0},{"bwq":0,"blr":0,"alr":1,"id":"45","end":0},{"end":0,"id":"46","blr":0,"alr":1,"bwq":0},{"bwq":0,"blr":0,"alr":1,"id":"47","end":0},{"id":"48","end":0,"bwq":0,"alr":1,"blr":0},{"id":"52","end":0,"bwq":0,"alr":1,"blr":0},{"end":0,"id":"54","blr":0,"alr":1,"bwq":0},{"end":0,"id":"55","blr":0,"alr":1,"bwq":0},{"id":"56","end":0,"bwq":0,"alr":1,"blr":0},{"alr":1,"blr":0,"bwq":0,"end":0,"id":"57"},{"alr":1,"blr":0,"bwq":0,"end":0,"id":"58"},{"end":0,"id":"59","blr":0,"alr":1,"bwq":0},{"end":0,"id":"60","blr":0,"alr":1,"bwq":0},{"bwq":0,"blr":0,"alr":1,"id":"61","end":0},{"end":0,"id":"62","blr":0,"alr":1,"bwq":0},{"bwq":0,"blr":0,"alr":1,"id":"63","end":0},{"bwq":0,"blr":0,"alr":1,"id":"64","end":0},{"bwq":0,"blr":0,"alr":1,"id":"65","end":0},{"bwq":0,"blr":0,"alr":1,"id":"72","end":0},{"id":"84","end":0,"bwq":0,"alr":1,"blr":0},{"end":0,"id":"93","blr":0,"alr":1,"bwq":0},{"bwq":0,"blr":0,"alr":1,"id":"131","end":0},{"id":"133","end":0,"bwq":0,"alr":1,"blr":0},{"id":"70","end":0,"bwq":0,"alr":1,"blr":0},{"end":0,"id":"134","blr":0,"alr":1,"bwq":0},{"id":"96","end":0,"bwq":0,"alr":1,"blr":0},{"id":"97","end":0,"bwq":0,"alr":1,"blr":0},{"bwq":0,"blr":0,"alr":1,"id":"98","end":0},{"bwq":0,"blr":0,"alr":1,"id":"99","end":0},{"bwq":0,"blr":0,"alr":1,"id":"100","end":0},{"end":0,"id":"101","blr":0,"alr":1,"bwq":0},{"end":0,"id":"102","blr":0,"alr":1,"bwq":0},{"bwq":0,"blr":0,"alr":1,"id":"103","end":0},{"id":"104","end":0,"bwq":0,"alr":1,"blr":0},{"alr":1,"blr":0,"bwq":0,"end":0,"id":"105"},{"bwq":0,"blr":0,"alr":1,"id":"106","end":0},{"end":0,"id":"107","blr":0,"alr":1,"bwq":0},{"alr":1,"blr":0,"bwq":0,"end":0,"id":"108"},{"alr":1,"blr":0,"bwq":0,"end":0,"id":"109"},{"end":0,"id":"112","blr":0,"alr":1,"bwq":0},{"end":0,"id":"113","blr":0,"alr":1,"bwq":0},{"id":"114","end":0,"bwq":0,"alr":1,"blr":0},{"alr":1,"blr":0,"bwq":0,"end":0,"id":"115"},{"bwq":0,"blr":0,"alr":1,"id":"116","end":0},{"id":"121","end":0,"bwq":0,"alr":1,"blr":0},{"bwq":0,"blr":0,"alr":1,"id":"122","end":0},{"bwq":0,"blr":0,"alr":1,"id":"123","end":0},{"bwq":0,"blr":0,"alr":1,"id":"124","end":0},{"end":0,"id":"125","blr":0,"alr":1,"bwq":0},{"alr":1,"blr":0,"bwq":0,"end":0,"id":"128"},{"bwq":0,"blr":1,"alr":0,"id":"129","end":0},{"id":"130","end":0,"bwq":0,"alr":1,"blr":0},{"bwq":0,"blr":0,"alr":1,"id":"135","end":0},{"alr":1,"blr":0,"bwq":0,"end":0,"id":"136"},{"bwq":0,"blr":0,"alr":1,"id":"142","end":0},{"alr":1,"blr":0,"bwq":0,"end":0,"id":"143"},{"end":0,"id":"144","blr":0,"alr":1,"bwq":0},{"bwq":0,"blr":0,"alr":1,"id":"145","end":0},{"end":0,"id":"146","blr":0,"alr":1,"bwq":0},{"end":0,"id":"147","blr":0,"alr":1,"bwq":0},{"id":"148","end":0,"bwq":0,"alr":1,"blr":0},{"id":"149","end":0,"bwq":0,"alr":1,"blr":0},{"id":"150","end":0,"bwq":0,"alr":1,"blr":0},{"alr":1,"blr":0,"bwq":0,"end":0,"id":"151"},{"end":0,"id":"152","blr":0,"alr":1,"bwq":0},{"bwq":0,"blr":0,"alr":1,"id":"153","end":0},{"end":0,"id":"154","blr":0,"alr":1,"bwq":0},{"bwq":0,"blr":0,"alr":1,"id":"155","end":0},{"id":"156","end":0,"bwq":0,"alr":1,"blr":0},{"id":"157","end":0,"bwq":0,"alr":1,"blr":0}];
  utag.loader.initcfg = function(){
    utag.loader.cfg={"68":{load:4,send:1,v:201810242104,wait:0,tid:1191},"127":{load:4,send:1,v:201811152137,wait:0,tid:7110},"128":{load:4,send:1,v:201812212226,wait:0,tid:19063},"18":{load:utag.cond[37],send:1,v:201603031531,wait:1,tid:20010},"155":{load:utag.cond[97],send:1,v:201812191854,wait:1,tid:8009},"134":{load:utag.cond[74],send:1,v:201703101612,wait:1,tid:20067},"135":{load:utag.cond[74],send:1,v:201703101612,wait:1,tid:20067},"90":{load:4,send:utag.cond[65],v:201612131734,wait:1,tid:20010},"129":{load:(utag.cond[59] && utag.cond[63]),send:1,v:201810242104,wait:1,tid:7122},"130":{load:utag.cond[62],send:0,v:201810242104,wait:1,tid:5001},"138":{load:utag.cond[77],send:1,v:201703212101,wait:1,tid:8009},"141":{load:utag.cond[54],send:1,v:201810242104,wait:1,tid:20010},"156":{load:utag.cond[81],send:1,v:201705011919,wait:1,tid:6031},"157":{load:utag.cond[82],send:1,v:201705011919,wait:1,tid:6031},"160":{load:utag.cond[83],send:1,v:201705011919,wait:1,tid:6031},"161":{load:utag.cond[84],send:1,v:201705011919,wait:1,tid:6031},"162":{load:utag.cond[85],send:1,v:201705011919,wait:1,tid:6031},"163":{load:utag.cond[86],send:1,v:201705011919,wait:1,tid:6031},"164":{load:utag.cond[87],send:1,v:201705011919,wait:1,tid:6031},"167":{load:utag.cond[89],send:1,v:201705102324,wait:1,tid:20067},"168":{load:utag.cond[90],send:1,v:201705102324,wait:1,tid:20067},"169":{load:utag.cond[91],send:1,v:201705102324,wait:1,tid:20067},"171":{load:utag.cond[89],send:1,v:201705121603,wait:1,tid:6026},"191":{load:utag.cond[92],send:1,v:201810242104,wait:1,tid:20010},"193":{load:utag.cond[96],send:1,v:201707122227,wait:1,tid:12047},"203":{load:utag.cond[106],send:1,v:201708220539,wait:1,tid:4001},"204":{load:utag.cond[107],send:1,v:201708220539,wait:1,tid:4001},"205":{load:utag.cond[108],send:1,v:201708220539,wait:1,tid:4001},"206":{load:utag.cond[109],send:1,v:201708220917,wait:1,tid:4001},"207":{load:utag.cond[110],send:1,v:201708220917,wait:1,tid:4001},"208":{load:utag.cond[111],send:1,v:201708220917,wait:1,tid:4001},"209":{load:utag.cond[112],send:1,v:201710040545,wait:1,tid:4001},"210":{load:utag.cond[113],send:1,v:201710040545,wait:1,tid:4001},"211":{load:utag.cond[114],send:1,v:201710130907,wait:1,tid:4001},"212":{load:utag.cond[115],send:1,v:201710130907,wait:1,tid:4001},"213":{load:utag.cond[116],send:1,v:201710130907,wait:1,tid:4001},"214":{load:utag.cond[117],send:1,v:201710130907,wait:1,tid:4001},"215":{load:utag.cond[118],send:1,v:201710130907,wait:1,tid:4001},"216":{load:utag.cond[119],send:1,v:201710130907,wait:1,tid:4001},"218":{load:utag.cond[120],send:1,v:201710230541,wait:1,tid:4001},"219":{load:utag.cond[121],send:1,v:201710230541,wait:1,tid:4001},"220":{load:utag.cond[122],send:1,v:201710230541,wait:1,tid:4001},"222":{load:utag.cond[123],send:1,v:201710230541,wait:1,tid:4001},"223":{load:utag.cond[124],send:1,v:201710230541,wait:1,tid:4001},"224":{load:utag.cond[125],send:1,v:201710230541,wait:1,tid:4001},"225":{load:utag.cond[126],send:1,v:201710230541,wait:1,tid:4001},"226":{load:utag.cond[127],send:1,v:201710230541,wait:1,tid:4001},"227":{load:utag.cond[128],send:1,v:201710240933,wait:1,tid:4001},"230":{load:utag.cond[129],send:1,v:201711291823,wait:1,tid:12047},"236":{load:utag.cond[130],send:1,v:201712070020,wait:1,tid:20067},"237":{load:utag.cond[131],send:1,v:201712070020,wait:1,tid:20067},"256":{load:utag.cond[132],send:1,v:201810242104,wait:1,tid:20010},"263":{load:utag.cond[133],send:1,v:201801112102,wait:1,tid:20067},"273":{load:4,send:utag.cond[136],v:201810242104,wait:1,tid:20010},"274":{load:utag.cond[135],send:1,v:201801292342,wait:1,tid:20067},"284":{load:1,send:1,v:201810242104,wait:1,tid:20010},"285":{load:utag.cond[137],send:1,v:201803090507,wait:1,tid:4001},"286":{load:utag.cond[137],send:1,v:201803090507,wait:1,tid:6026},"294":{load:utag.cond[79],send:1,v:201812212226,wait:1,tid:20010},"308":{load:utag.cond[139],send:1,v:201811050541,wait:1,tid:4001},"319":{load:utag.cond[140],send:1,v:201812212226,wait:1,tid:20010}};
utag.loader.cfgsort=["68","127","128","18","155","134","135","90","129","130","138","141","156","157","160","161","162","163","164","167","168","169","171","191","193","203","204","205","206","207","208","209","210","211","212","213","214","215","216","218","219","220","222","223","224","225","226","227","230","236","237","256","263","273","274","284","285","286","294","308","319"];
  }
utag.loader.initcfg();
}
...
//tealium universal tag - utag.sender.1191 ut4.0.201901152046, Copyright 2019 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {"id" : id};
...
//tealium universal tag - utag.sender.7110 ut4.0.201901152046, Copyright 2019 Tealium.com Inc. All Rights Reserved.
try{
...
// s.events=s.apl(s.events,"event1",",",1);
  ...
  //set 1 or more AMC customer IDs
	  wap_tms.amc.setCustomersIDs = function() {
        ...
        if ((typeof(utag_data.wa_load_tms_sync) === 'undefined' || utag_data.wa_load_tms_sync !== 'sync') && !s.targetCalled) { 
	...
	//Call Idio tag
	wap_tms.custom.callIdioTag(false);
}
...
//tealium universal tag - utag.sender.19063.am161 v4.0.201901152046, Copyright 2019 Tealium.com Inc. All Rights Reserved.
try{
  (function(id,loader,u){
    try{u=utag.o[loader].sender[id]={}}catch(e){u=utag.sender[id]};
  ...
  u.send=function(a,b,c,d,e,f,g,h,ev){
    if(u.ev[a]||typeof u.ev.all!="undefined"){
	  ...
	  wap_aa.config_event_map = function() {
      ...
      if(u.a=="view"){
		if (wap_aa.autofire && (typeof(utag_data.wa_load_tms_sync) !== 'undefined' && utag_data.wa_load_tms_sync === 'sync')) {
			setTimeout(function(){ 
				wap_aa.config_event_map();
			}, 500);
		}else if(wap_aa.autofire){
			wap_aa.config_event_map();
		}
      }else if(u.a=="link"){
...
//tealium universal tag - utag.sender.custom_container ut4.0.201901152046, Copyright 2019 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {};
    utag.o[loader].sender[id] = u;
...
try {
  (function (id, loader) {
    var u = {};
    utag.o[loader].sender[id] = u;
    if(utag_data.load_idio.indexOf('true') > -1){
      utag_data.tag_id_idio = id;
    }
    // Start Tealium loader 4.32
    // Please do not modify
    if (utag === undefined) { utag = {}; } if (utag.ut === undefined) { utag.ut = {}; } if (utag.ut.loader === undefined) { u.loader = function (o) { var a, b, c, l; a = document; if (o.type === "iframe") { b = a.createElement("iframe"); b.setAttribute("height", "1"); b.setAttribute("width", "1"); b.setAttribute("style", "display:none"); b.setAttribute("src", o.src); } else if (o.type === "img") { utag.DB("Attach img: " + o.src); b = new Image(); b.src = o.src; return; } else { b = a.createElement("script"); b.language = "javascript"; b.type = "text/javascript"; b.async = 1; b.charset = "utf-8"; b.src = o.src; } if (o.id) { b.id = o.id; } if (typeof o.cb === "function") { if (b.addEventListener) { b.addEventListener("load", function () { o.cb(); }, false); } else { b.onreadystatechange = function () { if (this.readyState === "complete" || this.readyState === "loaded") { this.onreadystatechange = null; o.cb(); } }; } } l = o.loc || "head"; c = a.getElementsByTagName(l)[0]; if (c) { utag.DB("Attach to " + l + ": " + o.src); if (l === "script") { c.parentNode.insertBefore(b, c); } else { c.appendChild(b); } } }; } else { u.loader = utag.ut.loader; }
  ...
  u.extend=[];
    ...
    u.send = function(a, b) {
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        /* Start Tag Sending Code */
/* 2018-09-10 */ ! function(a) {
    _iaq = [
        ["client", "intelcorp"],
        ["delivery", 1187]
    ];
    var b, c = {};
    "object" == typeof a && ((b = a.dnb_ultimateduns) && (c.Duns_ID = b), (b = a.dnb_duns) && (c.Duns_Ultimate_ID = b), (b = a.wa_aam_profile_id) && _iaq.push(["user", "AAMC_ID", b]), (b = a.wa_elq_id) && _iaq.push(["user", "eloqua_contact_id", b])), Object.keys(c).length && _iaq.push(["userinfo", c]), _iaq.push(["track", "consume"])
}(utag_data), 
! function(t, o, r) {
    "use strict";
    function n(t, n) {
        var e = new c(t),
            o = e.get() || ["xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function(t) {
                var n = 16 * Math.random() | 0,
                    e = "x" == t ? n : 3 & n | 8;
                return e.toString(16)
            })];
        return e.set(o[0], n), o
    }
    for (var e, i = r.hostname, a = [""]; e = i.indexOf(".", e) + 1;) a.push(";domain=." + i.substr(e));
    function c(t) {
        this.name = t, this.pattern = RegExp("(^|;)\\s*" + t + "=([^;]*)", "g")
    }(x = c.prototype).get = function() {
        for (var t, n = []; t = this.pattern.exec(o.cookie);) t[2] && n.push(t[2]);
        return n.sort(), n.length ? n : null
    }, x.set = function(t, n) {
        for (var e = a.length; e;) o.cookie = this.name + "=;expires=" + new Date(0).toGMTString() + a[--e] + ";path=/";
        for (e = a.length; e;) o.cookie = this.name + "=" + t + ";expires=" + new Date(+new Date + 36e5 * n).toGMTString() + a[--e] + ";path=/", this.get() && (e = 0)
    };
    var x, u = decodeURIComponent,
        s = encodeURIComponent;
    function f(t, n) {
        var e, o = [];
        for (e in t) "_" !== e && t.hasOwnProperty(e) && (o = o.concat(n(e)));
        return o
    }
    function h(t, n) {
        this._ = "//a.idio.co/" + t + "?", this.merge(n)
    }
    function p() {}(x = h.prototype).merge = function(n) {
        var e = this;
        f(n, function(t) {
            e[t] = n[t]
        })
        ...
        return i.merge({
            ...
            z: Math.random()
        }), i._ + f(i, function n(e, t, o) {
            var r = (t || i)[e];
            e = o ? o + "[" + e + "]" : e;
            return "object" == typeof r ? f(r, function(t) {
                return n(t, r, e)
            }) : s(e) + "=" + s(r)
        }).join("&")
    }, p.prototype.push = function() {
        for (var t = arguments, n = 0, e = t.length; n < e; n++) try {
            g[t[n].shift()].apply(null, t[n])
        } catch (t) {}
    };
    var g = {
            track: function(t, n) {
                if (t) {
                    var e = new h("ia.gif", d);
                    e.a = t, e.u = n || r.href, (new Image).src = e + ""
                }
            },
            user: function(t, n) {
                d.x[t] = (d.x[t] || []).concat(n)
            }
        },
        l = {
            client: "c",
    ...
    if (f(l, function(n) {
        ...
        for (var m, v, d = {
                ...
                s: n("is", .5)[0],
                x: {
                    idio_visitor_id: n("iv", 17520)
                }
            }, w = r.search.substr(1).split("&"), y = w.length; 0 < y--;) v = u((m = w[y].split("="))[1]), (m = u(m[0]).match(/^it(e|o|q|x\[(\w+)])$/)) && (m[2] ? d.x[m[2]] = [v] : d[m[1]] = v);
        var _ = t._iaq || [];
        (t._iaq = new p).push.apply(null, _)
    }
