...
If possible an ideal solution would be uncorrupted high abstraction code, that somehow translates to high performance code. The relevant keyword here is \textit{translate}. Compilers normally do this kind of stuff. The question arises whether we could utilize compiler technology to accomplish our goal.